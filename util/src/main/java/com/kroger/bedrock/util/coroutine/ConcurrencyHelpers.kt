...
public class SingleRunner {
     ...
     */
    public suspend fun <T> afterPrevious(block: suspend () -> T): T {
 ...
 */
public class ControlledRunner<T> {
    /**
     ...
     */
    public suspend fun cancelPreviousThenRun(block: suspend() -> T): T {
     ...
     */
    public suspend fun joinPreviousOrRun(block: suspend () -> T): T {
